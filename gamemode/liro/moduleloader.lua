...
-- For each module
local loadedTeams = false
for _, moduleName in pairs(moduleFolders) do
	if not loadedTeams and moduleName != "teams" then continue end
	if loadedTeams and moduleName == "teams" then continue end
	...
	if not loadedTeams and moduleName == "teams" then
		loadedTeams = true
		for _, moduleName in pairs(moduleFolders) do
	if not loadedTeams and moduleName != "teams" then continue end
	if loadedTeams and moduleName == "teams" then continue end
