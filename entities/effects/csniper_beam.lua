...
function EFFECT:Think()
	...
	self.Entity:SetPos( self.Weapon:GetOwner():GetShootPos() )
...
function EFFECT:Render()
	...
	origin = self:GetTracerShootPosAng(self.Weapon:GetOwner():GetShootPos(), self.Weapon, self.Attachment)
	//print(target)
	//print(origin)
	render.SetMaterial( LASER )
	render.DrawBeam(origin, target, 2, 0, beamscale, Color(255, 255, 255, 255))
